...
public class Store_GUI extends JFrame {
    ...
    private void onToCheckoutButtonClick(User u) {
        ...
        checkout.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(checkout, "Thank you for shopping at Buy Better!");
    ...
    private void rentItem(String i, User u){
        ...
        try {
            read = new BufferedReader(new FileReader(file));
            try (FileWriter writer = new FileWriter("./src/inventorysystem/User_Rentals.txt", true)) {
                String fileLine = read.readLine();
                while (fileLine != null) {
